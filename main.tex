...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://gerardbaholli.codes/}{\Large Gerard Baholli}} & Email : \href{mailto:gerardbaholli@gmail.com}{gerardbaholli@gmail.com}\\
  \href{https://gerardbaholli.codes/}{gerardbaholli.me} & Mobile : +39 347 2142985 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master degree in Computer Science}{Sep. 2019 -- Present}
    \resumeSubheading
      {Università Ca' Foscari Venezia}{Venice, IT}
      {Bachelor’s degree in Computer Science}{Sep. 2013 -- Dec. 2018}
    \resumeSubheading
      {Istituto Tecnico Economico Statale Riccati - Luzzatti}{Treviso, IT}
      {High School Diploma in }{Sep. 2008 -- Jun. 2013}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Extracurricular Internship}{June 2020 -- Present}
      \resumeItemListStart
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      {Curricular Internship}{Sep. 2017 -- Jan. 2018}
      \resumeItemListStart
